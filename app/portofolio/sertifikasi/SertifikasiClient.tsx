          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {certificates.map((cert, i) => (
              ...
              >
                ...
                >
                  <motion.div
                    className="relative overflow-hidden rounded-2xl bg-black/5 backdrop-blur-sm border border-black/10 hover:border-black/20 transition-colors duration-300"
                  ...
                  >
                    ...
                    {/* Card Info */}
                    <div className="p-5">
                      <h3 className="text-base font-bold text-gray-900 mb-1.5 line-clamp-2 transition-colors"
                        onMouseEnter={e => (e.currentTarget.style.color = "#c05878")}
                        onMouseLeave={e => (e.currentTarget.style.color = "")}>
                        {cert.name}
                      </h3>
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-zinc-500 text-sm line-clamp-1">{cert.issuer}</span>
